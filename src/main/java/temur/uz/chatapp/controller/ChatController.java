...
public class ChatController {
    ...
    @PostMapping("/save")
    public ResponseEntity<Result> newChatAdd(@RequestBody ChatDto dto) {
    ...
    @PutMapping("/{chat_id}")
    public ResponseEntity<Result> newUsersChatToAdd(@PathVariable Long chat_id, @RequestBody UserList userList) {
    ...
    public ResponseEntity<UserChatDto> getChat(@PathVariable Long userid){
